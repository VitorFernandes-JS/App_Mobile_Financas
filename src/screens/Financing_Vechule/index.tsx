...
import { SafeAreaView, Text, TextInput, Image, TouchableWithoutFeedback, Keyboard, Modal } from "react-native";
      ...
      <SafeAreaView>
          <Modal animationType="slide" transparent={true} visible={modal1}>
            <SafeAreaView style={styles.viewModal1}>
              ...
              <Text style={styles.modalSubtitle1}>Seu financiamento será de 1% até 30% da sua renda,{`\n`} isto é muito seguro!</Text>
              <BorderlessButton
        ...
        <SafeAreaView>
          <Modal animationType="slide" transparent={true} visible={modal2}>
            ...
            <AntDesign name={"checkcircle"} size={100} color={"#ffd900"} style={{top: -40}}/>
              <Text style={styles.modalSubtitle2}>Seu financiamento será de 31% até 60% da sua renda,{`\n`} isto NÃO é muito seguro!</Text>
              <BorderlessButton
        ...
        <SafeAreaView>
          <Modal animationType="slide" transparent={true} visible={modal3}>
            ...
            <AntDesign name={"checkcircle"} size={100} color={"#ff0000"} style={{top: -40}}/>
              <Text style={styles.modalSubtitle3}>Seu financiamento é 
              {`\n`}de ALTO RISCO!</Text>
              <BorderlessButton
